...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::post('/register-device-token', [\App\Http\Controllers\Api\DeviceTokenController::class, 'store'])
...
Route::middleware(['auth'])->group(function () {
    Route::get('/project-links', [App\Http\Controllers\ProjectController::class, 'projectLinks'])->name('project-links.index');
...
Route::middleware(['auth'])->group(function () {
    ...
    // New Project Module routes
    Route::get('/projects/{project}', [ProjectController::class, 'show'])->name('projects.show');
    Route::post('/projects/{project}/share-settings', [ProjectController::class, 'updateShareSettings'])->name('projects.share_settings');
    // Employee Routes
    Route::get('/my-projects', [ProjectController::class, 'myProjects'])->name('projects.my_projects');
    Route::get('/my-daily-updates', [ProjectController::class, 'myUpdates'])->name('projects.my_updates');
    
    // Daily Updates
    Route::post('/projects/{project}/updates', [\App\Http\Controllers\ProjectDailyUpdateController::class, 'store'])->name('project-updates.store');
    Route::post('/project-updates/{update}/approve', [\App\Http\Controllers\ProjectDailyUpdateController::class, 'approve'])->name('project-updates.approve');
    Route::post('/project-updates/{update}/reject', [\App\Http\Controllers\ProjectDailyUpdateController::class, 'reject'])->name('project-updates.reject');
    Route::delete('/project-updates/{update}', [\App\Http\Controllers\ProjectDailyUpdateController::class, 'destroy'])->name('project-updates.destroy');

    // General Daily Tasks
    Route::post('/general-daily-tasks', [\App\Http\Controllers\GeneralDailyTaskController::class, 'store'])->name('general-daily-tasks.store');
    Route::put('/general-daily-tasks/{task}', [\App\Http\Controllers\GeneralDailyTaskController::class, 'update'])->name('general-daily-tasks.update');
    Route::delete('/general-daily-tasks/{task}', [\App\Http\Controllers\GeneralDailyTaskController::class, 'destroy'])->name('general-daily-tasks.destroy');
    
    // Modules
    Route::post('/projects/{project}/modules', [\App\Http\Controllers\ProjectModuleController::class, 'store'])->name('project-modules.store');
    Route::get('/project-modules/{module}/edit', [\App\Http\Controllers\ProjectModuleController::class, 'edit'])->name('project-modules.edit');
    Route::put('/project-modules/{module}', [\App\Http\Controllers\ProjectModuleController::class, 'update'])->name('project-modules.update');
    Route::delete('/project-modules/{module}', [\App\Http\Controllers\ProjectModuleController::class, 'destroy'])->name('project-modules.destroy');
    
    // Reports
    Route::get('/report/projects', [\App\Http\Controllers\ProjectReportController::class, 'index'])->name('report.projects');
    Route::get('/report/employee-daily', [\App\Http\Controllers\ProjectReportController::class, 'employeeDailyReports'])->name('report.employee_daily');

    // Design Review and Approval System
    Route::resource('designs', \App\Http\Controllers\DesignController::class);
    Route::post('designs/{design}/versions', [\App\Http\Controllers\DesignVersionController::class, 'store'])->name('design-versions.store');
    Route::put('design-versions/{version}', [\App\Http\Controllers\DesignVersionController::class, 'update'])->name('design-versions.update');
    Route::delete('design-versions/{version}', [\App\Http\Controllers\DesignVersionController::class, 'destroy'])->name('design-versions.destroy');
    Route::post('design-versions/{version}/approve', [\App\Http\Controllers\DesignVersionController::class, 'approve'])->name('design-versions.approve');
    Route::post('design-versions/{version}/reject', [\App\Http\Controllers\DesignVersionController::class, 'reject'])->name('design-versions.reject');
    Route::post('design-versions/{version}/toggle-visibility', [\App\Http\Controllers\DesignVersionController::class, 'toggleVisibility'])->name('design-versions.toggle-visibility');

    Route::put('design-feedbacks/{feedback}', [\App\Http\Controllers\DesignFeedbackController::class, 'update'])->name('design-feedbacks.update');
    
    Route::get('reports/designs', [\App\Http\Controllers\DesignReportController::class, 'index'])->name('reports.designs');

});

// Public Client Report Route
Route::get('/project-report/{share_token}', [\App\Http\Controllers\ProjectReportController::class, 'publicClientReport'])->name('project.public.report');
Route::post('/project-report/{share_token}/verify', [\App\Http\Controllers\ProjectReportController::class, 'verifyPassword'])->name('project.public.verify');

// Public Feedback Submission
Route::post('design-versions/{version}/feedbacks', [\App\Http\Controllers\DesignFeedbackController::class, 'store'])->name('design-feedbacks.store');
Route::delete('design-feedbacks/{feedback}', [\App\Http\Controllers\DesignFeedbackController::class, 'destroy'])->name('design-feedbacks.destroy');

// Project Documents
Route::post('projects/{project}/documents', [\App\Http\Controllers\ProjectDocumentController::class, 'store'])->name('project-documents.store');
Route::delete('project-documents/{document}', [\App\Http\Controllers\ProjectDocumentController::class, 'destroy'])->name('project-documents.destroy');
Route::get('project-documents/{document}/download', [\App\Http\Controllers\ProjectDocumentController::class, 'download'])->name('project-documents.download');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('employee/check-approval', [EmployeeController::class, 'checkApproval'])->name('employee.check_approval')->middleware(['auth']);
    ...
    Route::post('attendance/overview', [AttendanceEmployeeController::class, 'attendanceOverview'])->name('attendance.overview');
    Route::get('attendance/report', [AttendanceEmployeeController::class, 'report'])->name('attendance.report')->middleware(
        [
            'auth',
            'XSS',
        ]
    ...
    Route::get('employee/offer-letter-view/{id}', [EmployeeController::class, 'joiningletterPdf'])->name('joiningletter.download.pdf');
    ...
    Route::post('/dashboard/send-wishes', [HomeController::class, 'sendWishes'])->name('dashboard.sendWishes');
