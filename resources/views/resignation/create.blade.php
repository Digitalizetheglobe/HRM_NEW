...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-lg-6 col-md-6">
            ...
            @if (\Auth::user()->type == 'employee')
                {{ Form::text('resignation_date', null, ['class' => 'form-control current_date', 'autocomplete' => 'off', 'required' => 'required', 'readonly' => 'readonly']) }}
            @else
...
<script>
    $(document).ready(function() {
        ...
        // Date calculation logic based on employee's service tenure
