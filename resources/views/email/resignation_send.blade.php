                                            ...
                                            <div class="mj-column-per-100 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                            <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                <p style="line-height:32px"><b style="font-weight:700">{{__('Subject: New Resignation Request Submitted')}}</b></p>
                                                                <p style="line-height:32px"><b style="font-weight:700">{{__('Dear Admin/HR Team,')}}</b></p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                            <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                <p style="margin: 10px 0;">{{__('An employee has submitted a resignation request with the following details:')}}</p>
                                                                <ul style="margin: 10px 0; padding-left: 20px;">
                                                                    <li><strong>{{__('Employee Name:')}}</strong> {{ $resignation->employee->full_name ?? '-' }}</li>
                                                                    <li><strong>{{__('Notice Date:')}}</strong> {{ \Auth::user()->dateFormat($resignation->notice_date) }}</li>
                                                                    <li><strong>{{__('Resignation Date:')}}</strong> {{ \Auth::user()->dateFormat($resignation->resignation_date) }}</li>
                                                                </ul>
                                                                @if(!empty($resignation->description))
                                                                    <p style="margin: 10px 0;"><strong>{{__('Reason/Description:')}}</strong> {{ $resignation->description }}</p>
                                                                @endif
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                            <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                <p style="margin: 10px 0;"><i style="font-style:normal">{{__('Please log in to the dashboard to review and take action.')}}</i></p>
