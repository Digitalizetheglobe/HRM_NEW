                        ...
                        <tbody>
                            @foreach ($tasks as $task)
                                <tr>
                                    ...
                                    <td class="text-start">{{ $task->start_date ? \Carbon\Carbon::parse($task->start_date)->format('Y-m-d H:i') : '-' }}</td>
                                    <td class="text-start">{{ $task->end_date ? \Carbon\Carbon::parse($task->end_date)->format('Y-m-d H:i') : '-' }}</td>
                                    <td class="text-start">
...
@push('scripts')
    <style>
        ...
        #pc-dt-simple th:nth-child(3) {
            min-width: 130px; /* Start Date */
        }
        
        #pc-dt-simple th:nth-child(4) {
            min-width: 130px; /* End Date */
        }
