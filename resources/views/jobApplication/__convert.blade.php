                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::date('dob', !empty($jobOnBoard->applications->dob) ? date('Y-m-d', strtotime($jobOnBoard->applications->dob)) : null, ['class' => 'form-control']) !!}
                        </div>
                    </div>
            ...
            <div class="card-body employee-detail-create-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-6 ">
                        ...
                        {!! Form::date('company_doj', !empty($jobOnBoard->joining_date) ? date('Y-m-d', strtotime($jobOnBoard->joining_date)) : null, ['class' => 'form-control ', 'required' => 'required']) !!}
                    </div>
