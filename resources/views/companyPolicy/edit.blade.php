                ...
                <div class="choose-files ">
                    <label for="attachment">
                        ...
                        @php
                             ...
                             @endphp
                        <input type="file" class="form-control file" name="attachment" id="attachment" onchange="document.getElementById('blah').innerHTML = '<i class=\'ti ti-file text-primary text-2xl\'></i> ' + this.files[0].name;">
                    </label>
                    <div id="blah" class="mt-2">
                        @if($companyPolicy->attachment)
                            <a href="{{$policyPath.$companyPolicy->attachment}}" target="_blank">
                                <i class="ti ti-file text-primary text-2xl"></i> {{$companyPolicy->attachment}}
                            </a>
                        @endif
                    </div>
                </div>
